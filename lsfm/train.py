...
def make_dataloaders(args):
    ...
    # StyleDataset의 __init__ 시그니처: (data_root, domain_list, train_txt, val_txt, transform)
    ...
    # AdaptDataset의 __init__ 시그니처: (data_root, source_domains, target_domains, transform)
...
def train_adapt(models, opts, dl, device, args):
    G, M       = models['G'], models['M']
    F_ext, clf = models['F_ext'], models['clf']
    optF, optC = opts['optF'], opts['optC']
