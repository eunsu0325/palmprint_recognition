...
def parse_args():
    ...
    parser.add_argument('--data_root',    type=str,   required=True,
                        help='Root directory of structured dataset') loss_D.backward(); opt_D.step()
            ...
            loss_G.backward(); opt_G.step(); opt_M.step(); opt_SE.step()
            ...
            loss_cls.backward(); opt_F.step(); opt_clf.step()
...
def train_adapt(models, optimizers, dataloaders, device, args):
    ...
    for epoch in range(args.num_epochs_adapt):
        for real_s, s_id, ds, real_t, dt in dataloaders['adapt']:
            ...
            opt_F.zero_grad(); opt_clf.zero_grad()
            loss_mmd.backward(); opt_F.step(); opt_clf.step()
